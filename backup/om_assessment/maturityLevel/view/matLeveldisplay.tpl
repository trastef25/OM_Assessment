       ...
       <h1 class="page-header marginleft"></h1>
        ...
        <form class="form-inline" role="form" action="../maturityLevel/updateMaturityLevel.php" method="POST">
              ...
              <label class="marginleft">ID</label>
                {section name=e loop= $edit}
               <input name="idLevel"  type="id_level" class="form-control" id="id_level"  value="{$edit[e].mat_lev_ID}" readonly>
              </div>
       
              <div class="form-group">
              <label class="marginleft">Level</label>
              <input name="levelName"type="text" class="form-control" id="exampleInputPassword1" value="{$edit[e].mat_lev_name}">
              </div>
              {/section}
              <div class="form-group">
