  ...
  <body>
   ...
   <div class="container">
     ...
     <div class="panel panel-default">
        ...
        <?php require("maturityLevel/controller/matLevController.php");?>
        ...
        <form class="form-inline" role="form" action="../maturityLevel/addMaturityLevel.php" method="POST">
               ...
               {foreach from=$maxIDLev item=maxID } 
               {$id=$maxID[mat_lev_ID]+1}
               <input name="idLevel"  type="id_level" class="form-control" id="id_level"  value="{$id}" readonly>
               {/foreach}
               </div>
              ...
              {/section}
               ...
               <span class="error">{$questIDErr}</span> 
          </form>
       ...
       <table class="table  levTable">
        ...
        {section name=l loop=$levelMat}
         <tbody>
          <tr>
          <td>{$levelMat[l].mat_lev_ID}</td>
          <td>{$levelMat[l].mat_lev_name}</td>
          <td>{$levelMat[l].quest_type}</td>
          <td> <a href='../maturityLevel/displayMaturityLevel.php?id={$levelMat[l].mat_lev_ID}&quest={$levelMat[l].quest_type}'><input class="btn btn-default" type="submit" name="editQuestion" value="edit"></a> </td>
          </tr>
         </tbody>
          {/section}
        </table>
