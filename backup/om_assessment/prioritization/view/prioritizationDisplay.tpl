   ...
   <div class="container">
     ...
     <div class="panel panel-default">
          ...
          <form class="form-inline" role="form" action="../prioritization/updatePrioritization.php" method="POST">
               {section name=infoPrio loop=$infoPriobyID}  
              
                <div class="form-group">
                <label class="marginleft">ID</label>
                <input name="idprio"  type="idprio" class="form-control" id="idprio"  value="{$infoPriobyID[infoPrio].prioritization_ID}" readonly> 
                </div>
                            
                <div class="form-group">
                <label class="marginleft" >Prioritization</label>
                <input name="PrioritizationName"type="text" class="form-control"  value="{$infoPriobyID[infoPrio].prioritization_name}"  >
                </div>

                <div class="form-group">
                <label class="marginleft"># Days</label>
                <input name="numDays"type="number" class="form-control"  min="1" value="{$infoPriobyID[infoPrio].num_days}">
                </div>
                {/section}
               <br><br>
