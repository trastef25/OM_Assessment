<?php /* Smarty version Smarty-3.1.16, created on 2014-05-04 02:31:48
         compiled from "..\users\view\updateRole.tpl" */ ?>
<?php /*%%SmartyHeaderCode:288453659d264f36a7-75134958%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b806253b0c9b22de2b341b3902db1d04b1f87a0' => 
    array (
      0 => '..\\users\\view\\updateRole.tpl',
      1 => 1399170692,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '288453659d264f36a7-75134958',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53659d2664e258_79440604',
  'variables' => 
  array (
    'infoRoles' => 0,
    'IdErr' => 0,
...
<?php if ($_valid && !is_callable('content_53659d2664e258_79440604')) {function content_53659d2664e258_79440604($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['x']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['infoRoles']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
              ...
              <input name="idUserRole"  type="id_UserRole" class="form-control" id="id_UserRole"  value="<?php echo $_smarty_tpl->tpl_vars['infoRoles']->value[$_smarty_tpl->getVariable('smarty')->value['section']['x']['index']]['role_ID'];?>
" readonly>
              </div>
       
              <div class="form-group">
              <label  class="marginleft" >Role</label>
              <input name="roleName"type="text" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['infoRoles']->value[$_smarty_tpl->getVariable('smarty')->value['section']['x']['index']]['role_name'];?>
" placeholder="Name">
              </div>
              ...
              <label class="marginleft">Description</label>              
               ...
               <div class="col-sm-4">
               <textarea name="roleDesc" class="form-control" rows="2" cols="30"><?php echo $_smarty_tpl->tpl_vars['infoRoles']->value[$_smarty_tpl->getVariable('smarty')->value['section']['x']['index']]['role_desc'];?>
</textarea>
               </div>
              </div> 
              <span class="clearfix" ></span>
