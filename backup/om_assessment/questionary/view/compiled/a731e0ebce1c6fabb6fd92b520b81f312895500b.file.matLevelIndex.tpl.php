<?php /* Smarty version Smarty-3.1.16, created on 2014-04-27 22:26:54
  ...
  <div id="mainContent"> 
   ...
   <div class="panel panel-default"> <!-- Default panel contents -->
       ...
       <h1 class="page-header marginleft"></h1>
        <h2 class="sub-header marginleft">Maturity Level</h2>
...
" readonly>
              ...
              <div class="form-group">
              <label >Level</label>
              <input name="levelName"type="text" class="form-control"  placeholder="Level Name">
              </div>
              <div class="form-group">
...
"><?php echo $_smarty_tpl->tpl_vars['atype']->value[$_smarty_tpl->getVariable('smarty')->value['section']['at']['index']]['quest_type'];?>
              ...
              <button type="submit" name="addLevelBtn"class="btn btn-info "> ADD</button>
              </br>
