<?php /* Smarty version Smarty-3.1.16, created on 2014-05-04 06:10:17
         compiled from "..\questionary\view\questionaryDisplay.tpl" */ ?>
<?php /*%%SmartyHeaderCode:32120535daa00934729-03121782%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '59c8f9b20766eadcd954022431bd359ca2300783' => 
    array (
      0 => '..\\questionary\\view\\questionaryDisplay.tpl',
      1 => 1399183327,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32120535daa00934729-03121782',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_535daa00a86693_60574692',
  'variables' => 
  array (
    'editQuestDisplay' => 0,
    'questErr' => 0,
...
<?php if ($_valid && !is_callable('content_535daa00a86693_60574692')) {function content_535daa00a86693_60574692($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['x']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['editQuestDisplay']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>             
              ...
              <input name="idQuestionary" type="text" class="form-control" id="id_questionary"  value="<?php echo $_smarty_tpl->tpl_vars['editQuestDisplay']->value[$_smarty_tpl->getVariable('smarty')->value['section']['x']['index']]['quest_ID'];?>
" readonly>
              </div>
                            
              <div class="form-group">
              <label  class="marginleft" >Questionary</label>
              <input name="questionayType"type="text" class="form-control"  value="<?php echo $_smarty_tpl->tpl_vars['editQuestDisplay']->value[$_smarty_tpl->getVariable('smarty')->value['section']['x']['index']]['quest_type'];?>
">
              </div>
              ...
              <div class="form-group">
               ...
               <div class="col-sm-4">
               <textarea name="description" class="form-control"  rows="2" cols="30"><?php echo $_smarty_tpl->tpl_vars['editQuestDisplay']->value[$_smarty_tpl->getVariable('smarty')->value['section']['x']['index']]['quest_desc'];?>
</textarea>
               </div>
              </div>
                <?php endfor; endif; ?>
