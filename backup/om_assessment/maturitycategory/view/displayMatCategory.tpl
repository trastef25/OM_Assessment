     ...
     <span class="clearfix" ></span>
      <br>
           ...
           <div class="panel panel-default">
                ...
                {section name=dis loop=$displayCatMat}
                <input name="idcat" type="id_Cat" class="form-control" id="id_Cat"  value="{$displayCatMat[dis].mat_cat_ID}" readonly>
                </div>

                <div class="form-group">
                <label class="marginleft">Categority</label>
                <input   type="text" class="form-control" id="exampleInputPassword1" placeholder="Categority Name" name="cat_name" value="{$displayCatMat[dis].mat_cat_name}">
                {/section}
                </div>
