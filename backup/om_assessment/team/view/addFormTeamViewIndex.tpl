            ...
            <div class="box box-element ui-draggable" style="display: block;">
              ...
              <form class="form-horizontal" role="form" method="POST" action="../team/addTeamIndex.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                   {foreach from=$maxIDTeam item=maxID } 
                   {$id=$maxID[team_ID]+1}
                    <input type="text" class="form-control" id="inputIdTeam" name="inputIdTeam" value="{$id}" readonly>
                   {/foreach}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputTeamName" value="{$teamName}" name="inputTeamName">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="date" class="form-control" id="inputTeamCreationDate" value="{$teamCreationDate}" name="inputTeamCreationDate">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputTeamLocalization" value="{$teamLocalization}" name="inputTeamLocalization">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputTeamRegion" value="{$teamRegion}" name="inputTeamRegion">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputTeamCapability" value="{$teamCapability}"  name="inputTeamCapability">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputTeamProcess" value="{$teamProcess}"name="inputTeamProcess">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputTeamFocal" value="{$teamFocal}" name="inputTeamFocal">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputTeamContract" value="{$teamContract}" name="inputTeamContract">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="Text" class="form-control" id="inputTeamClient" value="{$teamClient}" name="inputTeamClient">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="Text" class="form-control" id="inputTeamDM" value="{$teamDM}" name="inputTeamDM">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputTeamOEContact" value="{$teamOEContact}" name="inputTeamOEContact">
